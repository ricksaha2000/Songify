    ...
    i.VERSION = "3.2.0", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            ...
            if (this.affixed !== l) {
                ...
                this.$element.trigger(d), d.isDefaultPrevented() || (this.affixed = l, this.unpin = "bottom" == l ? this.getPinnedOffset() : null, this.$element.removeClass(i.RESET).addClass(h).trigger(t.Event(h.replace("affix", "affixed"))), "bottom" == l && this.$element.offset({
...
function (t) {
    t.flexslider = function (e, i) {
        ...
        var n, a = s.vars.namespace,
            ...
            c = s.vars.reverse,
            u = s.vars.itemWidth > 0,
            p = "fade" === s.vars.animation,
            m = "" !== s.vars.asNavFor,
            f = {},
            v = !0;
        t.data(e, "flexslider", s), f = {
            ...
            controlNav: {
                ...
                setupPaging: function () {
                    var e, i, n = "thumbnails" === s.vars.controlNav ? "control-thumbs" : "control-paging",
                        o = 1;
                    if (s.controlNavScaffold = t('<ol class="' + a + "control-nav " + a + n + '"></ol>'), s.pagingCount > 1)
            ...
            if (p) s.slides.css({
                ...
                opacity: 1
            }, s.vars.animationSpeed, s.vars.easing)), s.vars.smoothHeight && f.smoothHeight();
            else {
                var i, n;
...
function (t, e) {
    ...
    t.fn.jPlayer = function (i) {
        ...
        return i = !n && a.length ? t.extend.apply(null, [!0, i].concat(a)) : i, n && "_" === i.charAt(0) ? o : (this.each(n ? function () {
            var n = t(this).data(s),
                r = n && t.isFunction(n[i]) ? n[i].apply(n, a) : n;
    ...
    a.platform && (t.jPlayer.platform[a.platform] = !0, t.jPlayer.platform.mobile = !a.tablet, t.jPlayer.platform.tablet = !!a.tablet), t.jPlayer.getDocMode = function () {
        ...
        init: function () {
            var t, e, i, s = document,
                n = s.createElement("video"),
                a = {
    ...
    t.jPlayer.keys = function (e) {
        ...
        playbackRateBar: function (e) {
            if (this.css.jq.playbackRateBar.length) {
                var i, s, n = t(e.currentTarget),
                    a = n.offset(),
                    o = e.pageX - a.left,
                    r = n.width(),
                    l = n.height() - e.pageY + a.top,
                    h = n.height();
        ...
        _html_pause: function (t) {
            var e = this,
                i = this.htmlElement.media;
            if (this.androidFix.play = !1, t > 0 ? this._html_load() : clearTimeout(this.internal.htmlDlyCmdId), i.pause(), this.androidFix.setMedia) this.androidFix.pause = !0, this.androidFix.time = t;
            else if (!isNaN(t)) try {
                if (i.seekable && !("object" == typeof i.seekable && i.seekable.length > 0)) throw 1;
                i.currentTime = t
            } catch (s) {
        ...
        _html_playHead: function (t) {
            ...
            this._html_load();
            try {
                if ("object" == typeof i.seekable && i.seekable.length > 0) i.currentTime = t * i.seekable.end(i.seekable.length - 1) / 100;
                else {
        ...
        _getFlashPluginVersion: function () {
            ...
            } catch (s) {} else navigator.plugins && navigator.mimeTypes.length > 0 && (t = navigator.plugins["Shockwave Flash"], t && (e = navigator.plugins["Shockwave Flash"].description.replace(/.*\s(\d+\.\d+).*/, "$1")));
            return 1 * e
        },
            ...
            t.fn[e] = function (n) {
                if ("string" == typeof n) {
                    for (var o = s.call(arguments, 1), r = 0, l = this.length; l > r; r++) {
                        ...
                        else a("cannot call methods on " + e + " prior to initialization; attempted to call '" + n + "'")
                    }
                    return this
                }
                return this.each(function () {
...
function (t) {
    "use strict";
    var e = "selectric",
        i = "Input Items Open Disabled TempShow HideSelect Wrapper Hover Responsive Above Scroll",
        s = ".sl",
        n = {
            onChange: function (e) {
                t(e).change()
        ...
        h = function (a, h) {
            ...
            function c() {
                ...
                var i = $.children(),
                    n = "<ul>",
                    a = i.filter(":selected").index();
                T = x = ~a ? a : 0, (F = i.length) && (i.each(function (e) {
                    var i = t(this),
                        s = i.html(),
                        a = i.prop("disabled"),
                        r = L.options.optionsItemBuilder;
                    L.items[e] = {
                        value: i.val(),
                        text: s,
                    ...
                    tabindex: D,
                    disabled: !1
                }).on("keypress" + s, p).on("keydown" + s, function (t) {
            ...
            function m() {
                var t = P.closest(":visible").children(":hidden"),
                    e = L.options.maxHeight;
                t.addClass(L.classes.tempshow);
                var i = P.outerWidth(),
                    s = S.outerWidth() - (i - P.width());
            ...
            var w, P, C, S, j, E, k, x, T, q, O, N, F, M, L = this,
                $ = t(a),
                A = !1,
                R = !1,
                I = /android|ip(hone|od|ad)/i.test(navigator.userAgent),
                D = $.prop("tabindex");
            d(h)
        };
    t.fn[e] = function (i) {
    ...
    return function (t) {
        ...
        function (t) {
            function i(e, i) {
                ...
                var n, a, o, r = this.element.style.width,
                    l = !1,
                    h = this.element.parentNode;
                if (this.sliderElem) l = !0;
                else {
                ...
                var b = ["round", "triangle", "custom"],
                    _ = -1 !== b.indexOf(this.options.handle);
            ...
            if (e = function (t, e) {
                    ...
                    _layout: function () {
                        ...
                        if (t = this.options.reversed ? [100 - this.percentage[0], this.percentage[1]] : [this.percentage[0], this.percentage[1]], this.handle1.style[this.stylePos] = t[0] + "%", this.handle2.style[this.stylePos] = t[1] + "%", "vertical" === this.options.orientation) this.trackSelection.style.top = Math.min(t[0], t[1]) + "%", this.trackSelection.style.height = Math.abs(t[0] - t[1]) + "%";
                            ...
                            var e = this.tooltip_min.getBoundingClientRect(),
                    ...
                    _keydown: function (t, e) {
                        ...
                        if (i) {
                            ...
                            var a = i * this.percentage[2],
                                o = this.percentage[t] + a;
